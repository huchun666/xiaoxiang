    ...
    <div class="about-us-title">
      ...
      <div class="about-us-title-box">
        ...
        <div class="about-us-title-box-bottom">
          ...
          <div class="about-us-title-box-bottom-bottom">东芯半导体是目前国内领先的可以同时提供 NAND/NOR/DRAM 设计工艺和产品方案的本土存储芯片研发设计公司</div>
        </div>
      </div>
    </div>
      ...
      <div class="investment-after-box">
        <div class="about-us-content-text" id="navigate1">
          ...
          <div class="about-us-content-text-bottom">
            <div class="about-us-content-text-bottom-text">东芯半导体聚焦的是中小容量NAND、NOR的闪存芯片，是目前国内领先的可以同时提供NAND/NOR/DRAM设计工艺和产品方案的本土存储芯片研发设计公司。并于2015年收购韩国上市公司Fidelix（证券代码032580）。Fidelix系韩国第三大存储器生产厂商。</div>
          </div>
        </div>
